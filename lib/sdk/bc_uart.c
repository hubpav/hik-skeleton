...
void bc_uart_init(bc_uart_channel_t channel, bc_uart_baudrate_t baudrate, bc_uart_setting_t setting)
{
    ...
    switch(channel)
    {
        case BC_UART_UART0:
        {
            ...
            GPIOA->AFR[0] |= 6 << GPIO_AFRL_AFSEL1_Pos | 6 << GPIO_AFRL_AFSEL0_Pos;
        ...
        case BC_UART_UART1:
        {
            ...
            if (baudrate <= BC_UART_BAUDRATE_9600)
            {
                ...
                GPIOA->AFR[0] |= 6 << GPIO_AFRL_AFSEL3_Pos | 6 << GPIO_AFRL_AFSEL2_Pos;
            ...
            else
            {
                ...
                GPIOA->AFR[0] |= 4 << GPIO_AFRL_AFSEL3_Pos | 4 << GPIO_AFRL_AFSEL2_Pos;
...
void bc_uart_deinit(bc_uart_channel_t channel)
{
    ...
    switch(channel)
    {
        case BC_UART_UART0:
        {
            ...
            GPIOA->AFR[0] &= ~(GPIO_AFRL_AFSEL1_Msk | GPIO_AFRL_AFSEL0_Msk);
        ...
        case BC_UART_UART1:
        {
            ...
            GPIOA->AFR[0] &= ~(GPIO_AFRL_AFSEL3_Msk | GPIO_AFRL_AFSEL2_Msk);
